...
--1.
CREATE OR REPLACE FUNCTION crea_log_representantes_aprobados()
RETURNS Trigger AS $$
BEGIN
  IF TG_OP = 'INSERT'
...
INSERT OR UPDATE OR DELETE ON Representante_aprobado
  FOR EACH ROW EXECUTE PROCEDURE crea_log_representantes_aprobados();
